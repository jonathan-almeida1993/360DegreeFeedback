...
function _init() {
  ...
  $.admin.tree = function (menu) {
    ...
    $("li a", $(menu)).on('click', function (e) {
      ...
      else if (($(this).parent().hasClass('treeview'))) {    	  
    	  if($(".treeview").hasClass("active")){
    		  if($(".treeview").find("ul").hasClass("menu-open")){
    			  $(".treeview").find("ul").removeClass("menu-open");
    			  $(".treeview").find("ul").css("display", "none");
    			  $(".treeview-menu").find('li').removeClass("activeSubmenu");
    		  }       
      ...
      else if($(this).parents('ul').hasClass('treeview-menu')){
		  if($(this).parents('ul').hasClass("menu-open")){
			  $(this).parents('ul').find('li').removeClass("activeSubmenu");
